...
export const INDIAN_CITY_OPTIONS: Record<string, readonly string[]> = {
  "Andhra Pradesh": ["Visakhapatnam", "Vijayawada", "Guntur", "Tirupati", "Kakinada", "Rajamahendravaram"],
  ...
  "Himachal Pradesh": ["Shimla", "Mandi", "Dharamshala", "Solan", "Kullu", "Una"],
...
export const getCityItemsForState = (state?: string) =>
  (INDIAN_CITY_OPTIONS[state || ""] || []).map((city) => ({ label: city, value: city }));
